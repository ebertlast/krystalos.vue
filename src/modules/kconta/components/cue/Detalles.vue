    ...
    <v-layout row wrap>
        ...
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">COMPANIA</span>
              <div>{{(model && model.COMPANIA) ? model.COMPANIA : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      ...
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">RETENCION</span>
              <div>{{(model && model.RETENCION) ? model.RETENCION : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CPTORETENCION</span>
              <div>{{(model && model.CPTORETENCION) ? model.CPTORETENCION : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">AJUSTE</span>
              <div>{{(model && model.AJUSTE) ? model.AJUSTE : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CIERRE</span>
              <div>{{(model && model.CIERRE) ? model.CIERRE : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CUENTAFISCAL</span>
              <div>{{(model && model.CUENTAFISCAL) ? model.CUENTAFISCAL : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      ...
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">RUBRO</span>
              <div>{{(model && model.RUBRO) ? model.RUBRO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">TIPOTESORERO</span>
              <div>{{(model && model.TIPOTESORERO) ? model.TIPOTESORERO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      ...
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CTA_BCO</span>
              <div>{{(model && model.CTA_BCO) ? model.CTA_BCO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CODCAJA</span>
              <div>{{(model && model.CODCAJA) ? model.CODCAJA : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">DETALLEXTERCERO</span>
              <div>{{(model && model.DETALLEXTERCERO) ? model.DETALLEXTERCERO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">RESPONSABLE</span>
              <div>{{(model && model.RESPONSABLE) ? model.RESPONSABLE : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CUENTA_HOMOLOGA</span>
              <div>{{(model && model.CUENTA_HOMOLOGA) ? model.CUENTA_HOMOLOGA : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CUENTANIIF</span>
              <div>{{(model && model.CUENTANIIF) ? model.CUENTANIIF : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CONCEPTOEXO</span>
              <div>{{(model && model.CONCEPTOEXO) ? model.CONCEPTOEXO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">FORMATOEXO</span>
              <div>{{(model && model.FORMATOEXO) ? model.FORMATOEXO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">NODEDUCIBLE</span>
              <div>{{(model && model.NODEDUCIBLE) ? model.NODEDUCIBLE : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">ASUMIDA_PRACTICADA</span>
              <div>{{(model && model.ASUMIDA_PRACTICADA) ? model.ASUMIDA_PRACTICADA : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CTACIERRECOSTOS</span>
              <div>{{(model && model.CTACIERRECOSTOS) ? model.CTACIERRECOSTOS : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">CTACREDITOCOSTOS</span>
              <div>{{(model && model.CTACREDITOCOSTOS) ? model.CTACREDITOCOSTOS : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
...
export default {
  ...
  methods: {
    ...
    refrescarDatos() {
      if (!this.fila || !this.fila.CUENTA || !this.fila.COMPANIA) return;
      this.cargando = true;
      this.model = {};
      this.$http
        .get(`cue/${this.fila.CUENTA}/${this.fila.COMPANIA}`)
        .then(res => {
