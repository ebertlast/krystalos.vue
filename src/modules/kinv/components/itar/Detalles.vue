    ...
    <v-container grid-list-md text-xs-center>
      ...
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MCCN</span>
              <div>{{(model && model.MCCN) ? model.MCCN : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MUNI</span>
              <div>{{(model && model.MUNI) ? model.MUNI : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      ...
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MFECHAVENCIMIENTO</span>
              <div>{{(model && model.MFECHAVENCIMIENTO) ? model.MFECHAVENCIMIENTO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      ...
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">PINDIVIDUAL</span>
              <div>{{(model && model.PINDIVIDUAL) ? model.PINDIVIDUAL : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">DECONSUMO</span>
              <div>{{(model && model.DECONSUMO) ? model.DECONSUMO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">PREFIJO</span>
              <div>{{(model && model.PREFIJO) ? model.PREFIJO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      ...
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MSTOCK</span>
              <div>{{(model && model.MSTOCK) ? model.MSTOCK : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MPRINCIPAL</span>
              <div>{{(model && model.MPRINCIPAL) ? model.MPRINCIPAL : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MCNS</span>
              <div>{{(model && model.MCNS) ? model.MCNS : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">PRECNS</span>
              <div>{{(model && model.PRECNS) ? model.PRECNS : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MGRUPO</span>
              <div>{{(model && model.MGRUPO) ? model.MGRUPO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MLABILIDAD</span>
              <div>{{(model && model.MLABILIDAD) ? model.MLABILIDAD : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
      <v-flex xs3>
        <v-hover>
          <v-card slot-scope="{ hover }" :class="`elevation-${hover ? 12 : 2}`" class="mx-auto">
            <v-card-text class="text-sm-left">
              <span class="grey--text">MRIESGO</span>
              <div>{{(model && model.MRIESGO) ? model.MRIESGO : ""}}</div>
            </v-card-text>
          </v-card>
        </v-hover>
      </v-flex>
